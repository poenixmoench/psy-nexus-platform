...
import { ollamaQueue } from './ollama-queue'; // <-- NEU: Queue Import
...
  private coderModel = 'qwen:7b';

  async executeAgent(agentType: string, prompt: string, context: string[] = []): Promise<AgentResult> {
    switch (agentType) {

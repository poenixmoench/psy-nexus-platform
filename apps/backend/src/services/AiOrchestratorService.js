...
var AiOrchestratorService = /** @class */ (function () {
    ...
    AiOrchestratorService.prototype.orchestrate = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.post("".concat(this.ollamaUrl, "/api/generate"), {
                                model: 'qwen:7b',
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, { success: true, response: response.data }];
                    case 2:
                        error_1 = _a.sent();
                        throw new Error('Orchestration failed: ' + error_1.message);

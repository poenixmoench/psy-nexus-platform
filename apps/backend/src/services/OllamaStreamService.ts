...
export class OllamaStreamService {
    private readonly agentModel = process.env.OLLAMA_MODEL || 'qwen2.5-coder:14b';
    private readonly ollamaApiUrl = process.env.OLLAMA_API_URL || 'http://host.docker.internal:11435';

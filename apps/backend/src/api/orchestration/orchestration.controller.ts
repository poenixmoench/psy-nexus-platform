...
// Definiere das Agent Interface (zur Wiederverwendung aus dem Frontend)
interface Agent {
    id: string;
    name: string;
    status: 'LIVE' | 'BESCHÄFTIGT' | 'INAKTIV';
    description: string;
    model: string;
    latency: number;
}
...
// ------------------------------------------
export const registerOrchestrationRoutes = (io: Server): Router => {

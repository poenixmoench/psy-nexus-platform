...
const _hoisted_1 = { class: "agent-studio" };
const _hoisted_2 = { class: "chat-section" };
const _hoisted_3 = { class: "chat-header" };
const _hoisted_4 = { class: "message-log" };
const _hoisted_5 = { class: "msg-sender" };
const _hoisted_6 = { class: "msg-content" };
const _hoisted_7 = { class: "controls" };
const _hoisted_8 = { class: "preview-section" };
const _hoisted_9 = { class: "preview-header" };
const _hoisted_10 = { class: "preview-status" };
const _hoisted_11 = ["srcdoc"];
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "AgentDevStudio",
  setup(__props) {
    const messages = ref([]);
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("section", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            _cache[2] || (_cache[2] = createBaseVNode("h1", { class: "chat-title" }, "AGENT DEV STUDIO", -1)),
            createBaseVNode("div", {
              class: normalizeClass(["status-indicator", `status-${orionStatus.value}`])
            }, " [" + toDisplayString(orionStatus.value.toUpperCase()) + "] ", 3)
          ]),
          createBaseVNode("div", _hoisted_4, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(messages.value, (msg, idx) => {
              return openBlock(), createElementBlock("div", {
                key: idx,
                class: normalizeClass(["message", `msg-${msg.type}`])
              }, [
                createBaseVNode("span", _hoisted_5, "[" + toDisplayString(msg.sender.toUpperCase()) + "]:", 1),
                createBaseVNode("span", _hoisted_6, toDisplayString(msg.content), 1)
              ], 2);
            }), 128))
          ]),
          createBaseVNode("div", _hoisted_7, [
            withDirectives(createBaseVNode("select", {
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => selectedAgent.value = $event),
              class: "agent-select",
              "aria-label": "Agent auswählen"
            }, [..._cache[3] || (_cache[3] = [
              createStaticVNode('<option value="" data-v-2ae576d3>-- Agent --</option><option value="orion" data-v-2ae576d3>ORION</option><option value="nexus-prime" data-v-2ae576d3>NEXUS-PRIME</option><option value="aura" data-v-2ae576d3>AURA</option><option value="syntax" data-v-2ae576d3>SYNTAX</option><option value="validus" data-v-2ae576d3>VALIDUS</option><option value="mirror" data-v-2ae576d3>MIRROR</option><option value="infra" data-v-2ae576d3>INFRA</option>', 8)
            ])], 512), [
              [vModelSelect, selectedAgent.value]
            ]),
        ...
        createBaseVNode("section", _hoisted_8, [
          createBaseVNode("div", _hoisted_9, [
            _cache[4] || (_cache[4] = createBaseVNode("h2", null, "LIVE PREVIEW", -1)),
            createBaseVNode("span", _hoisted_10, "[" + toDisplayString(previewStatus.value) + "]", 1)
          ]),
...
const AgentDevStudio = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2ae576d3"]]);
const routes = [
